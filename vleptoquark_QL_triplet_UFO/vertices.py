...
V_132 = Vertex(name = 'V_132',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS2 ],
               couplings = {(0,0):C.GC_122,(0,1):C.GC_120})
...
V_165 = Vertex(name = 'V_165',
               ...
               couplings = {(0,0):C.GC_15,(1,1):C.GC_15})
...
V_171 = Vertex(name = 'V_171',
               ...
               couplings = {(0,1):C.GC_12,(0,0):C.GC_88})

V_172 = Vertex(name = 'V_172',
               particles = [ P.gp, P.V1__tilde__, P.V1 ],
               color = [ 'T(1,3,2)' ],
               lorentz = [ L.VVV1, L.VVV2 ],
               couplings = {(0,1):C.GC_12,(0,0):C.GC_106})

V_173 = Vertex(name = 'V_173',
               particles = [ P.g, P.g, P.V1__tilde__, P.V1 ],
               color = [ 'f(-1,1,2)*T(-1,4,3)', 'T(1,-1,3)*T(2,4,-1)', 'T(1,4,-1)*T(2,-1,3)' ],
               lorentz = [ L.VVVV1, L.VVVV3, L.VVVV4 ],
               couplings = {(0,0):C.GC_89,(1,1):C.GC_15,(2,2):C.GC_15})

V_174 = Vertex(name = 'V_174',
               particles = [ P.g, P.gp, P.V1__tilde__, P.V1 ],
               color = [ 'f(-1,1,2)*T(-1,4,3)', 'T(1,-1,3)*T(2,4,-1)', 'T(1,4,-1)*T(2,-1,3)' ],
               lorentz = [ L.VVVV1, L.VVVV3, L.VVVV4 ],
               couplings = {(0,0):C.GC_107,(1,1):C.GC_15,(2,2):C.GC_15})

V_175 = Vertex(name = 'V_175',
               particles = [ P.gp, P.gp, P.V1__tilde__, P.V1 ],
...
V_177 = Vertex(name = 'V_177',
               particles = [ P.gp, P.V2__tilde__, P.V2 ],
               color = [ 'T(1,3,2)' ],
               lorentz = [ L.VVV1, L.VVV2 ],
               couplings = {(0,1):C.GC_12,(0,0):C.GC_106})
...
V_179 = Vertex(name = 'V_179',
               particles = [ P.g, P.gp, P.V2__tilde__, P.V2 ],
               color = [ 'f(-1,1,2)*T(-1,4,3)', 'T(1,-1,3)*T(2,4,-1)', 'T(1,4,-1)*T(2,-1,3)' ],
               lorentz = [ L.VVVV1, L.VVVV3, L.VVVV4 ],
               couplings = {(0,0):C.GC_107,(1,1):C.GC_15,(2,2):C.GC_15})

V_180 = Vertex(name = 'V_180',
               particles = [ P.gp, P.gp, P.V2__tilde__, P.V2 ],
               color = [ 'T(1,-1,3)*T(2,4,-1)', 'T(1,4,-1)*T(2,-1,3)' ],
               lorentz = [ L.VVVV2 ],
               couplings = {(1,0):C.GC_14,(0,0):C.GC_14})

V_181 = Vertex(name = 'V_181',
               particles = [ P.g, P.V3__tilde__, P.V3 ],
               color = [ 'T(1,3,2)' ],
               lorentz = [ L.VVV1, L.VVV2 ],
               couplings = {(0,1):C.GC_12,(0,0):C.GC_88})

V_182 = Vertex(name = 'V_182',
               particles = [ P.gp, P.V3__tilde__, P.V3 ],
               color = [ 'T(1,3,2)' ],
               lorentz = [ L.VVV1, L.VVV2 ],
               couplings = {(0,1):C.GC_12,(0,0):C.GC_106})

V_183 = Vertex(name = 'V_183',
               particles = [ P.g, P.g, P.V3__tilde__, P.V3 ],
               color = [ 'f(-1,1,2)*T(-1,4,3)', 'T(1,-1,3)*T(2,4,-1)', 'T(1,4,-1)*T(2,-1,3)' ],
               lorentz = [ L.VVVV1, L.VVVV3, L.VVVV4 ],
               couplings = {(0,0):C.GC_89,(1,1):C.GC_15,(2,2):C.GC_15})

V_184 = Vertex(name = 'V_184',
               particles = [ P.g, P.gp, P.V3__tilde__, P.V3 ],
               color = [ 'f(-1,1,2)*T(-1,4,3)', 'T(1,-1,3)*T(2,4,-1)', 'T(1,4,-1)*T(2,-1,3)' ],
               lorentz = [ L.VVVV1, L.VVVV3, L.VVVV4 ],
               couplings = {(0,0):C.GC_107,(1,1):C.GC_15,(2,2):C.GC_15})

V_185 = Vertex(name = 'V_185',
               particles = [ P.gp, P.gp, P.V3__tilde__, P.V3 ],
               color = [ 'T(1,-1,3)*T(2,4,-1)', 'T(1,4,-1)*T(2,-1,3)' ],
               lorentz = [ L.VVVV2 ],
               couplings = {(1,0):C.GC_14,(0,0):C.GC_14})

V_186 = Vertex(name = 'V_186',
               particles = [ P.t__tilde__, P.e__minus__, P.V1 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_159})

V_187 = Vertex(name = 'V_187',
               particles = [ P.t__tilde__, P.mu__minus__, P.V1 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_162})

V_188 = Vertex(name = 'V_188',
               particles = [ P.t__tilde__, P.ta__minus__, P.V1 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_165})

V_189 = Vertex(name = 'V_189',
               particles = [ P.b__tilde__, P.ve, P.V3 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_159})

V_190 = Vertex(name = 'V_190',
               particles = [ P.b__tilde__, P.vm, P.V3 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_162})

V_191 = Vertex(name = 'V_191',
               particles = [ P.b__tilde__, P.vt, P.V3 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_165})

V_192 = Vertex(name = 'V_192',
               particles = [ P.b__tilde__, P.e__minus__, P.V2 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_160})

V_193 = Vertex(name = 'V_193',
               particles = [ P.t__tilde__, P.ve, P.V2 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_161})

V_194 = Vertex(name = 'V_194',
               particles = [ P.b__tilde__, P.mu__minus__, P.V2 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_163})

V_195 = Vertex(name = 'V_195',
               particles = [ P.t__tilde__, P.vm, P.V2 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_164})

V_196 = Vertex(name = 'V_196',
               particles = [ P.b__tilde__, P.ta__minus__, P.V2 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_166})

V_197 = Vertex(name = 'V_197',
               particles = [ P.t__tilde__, P.vt, P.V2 ],
               color = [ 'Identity(1,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_167})

V_198 = Vertex(name = 'V_198',
               particles = [ P.e__plus__, P.t, P.V1__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_108})

V_199 = Vertex(name = 'V_199',
               particles = [ P.mu__plus__, P.t, P.V1__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_111})

V_200 = Vertex(name = 'V_200',
               particles = [ P.ta__plus__, P.t, P.V1__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_114})

V_201 = Vertex(name = 'V_201',
               particles = [ P.e__plus__, P.b, P.V2__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_109})

V_202 = Vertex(name = 'V_202',
               particles = [ P.mu__plus__, P.b, P.V2__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_112})

V_203 = Vertex(name = 'V_203',
               particles = [ P.ta__plus__, P.b, P.V2__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_115})

V_204 = Vertex(name = 'V_204',
               particles = [ P.ve__tilde__, P.t, P.V2__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_110})

V_205 = Vertex(name = 'V_205',
               particles = [ P.ve__tilde__, P.b, P.V3__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_108})

V_206 = Vertex(name = 'V_206',
               particles = [ P.vm__tilde__, P.t, P.V2__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_113})

V_207 = Vertex(name = 'V_207',
               particles = [ P.vm__tilde__, P.b, P.V3__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_111})

V_208 = Vertex(name = 'V_208',
               particles = [ P.vt__tilde__, P.t, P.V2__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_116})

V_209 = Vertex(name = 'V_209',
               particles = [ P.vt__tilde__, P.b, P.V3__tilde__ ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.FFV2 ],
               couplings = {(0,0):C.GC_114})
