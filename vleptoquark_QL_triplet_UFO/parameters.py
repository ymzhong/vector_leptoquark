...
WV1 = Parameter(name = 'WV1',
                nature = 'internal',
                type = 'real',
                value = '((1 - MT**2/MV3**2)**2*(1 + MT**2/(2.*MV3**2))*MV3*(abs(Y13)**2 + abs(Y23)**2 + abs(Y33)**2))/(24.*cmath.pi)',
                texname = 'W_{\\text{V1}}')

WV2 = Parameter(name = 'WV2',
                nature = 'internal',
                type = 'real',
                value = '(MV3*abs(Y13)**2)/(48.*cmath.pi) + ((1 - MT**2/MV3**2)**2*(1 + MT**2/(2.*MV3**2))*MV3*(abs(Y13)**2 + abs(Y23)**2 + abs(Y33)**2))/(48.*cmath.pi)',
                texname = 'W_{\\text{V2}}')

WV3 = Parameter(name = 'WV3',
                nature = 'internal',
                type = 'real',
                value = '(MV3*(abs(Y13)**2 + abs(Y23)**2 + abs(Y33)**2))/(24.*cmath.pi)',
                texname = 'W_{\\text{V3}}')
